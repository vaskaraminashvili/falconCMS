...
<html lang="en-US" dir="ltr" class="dark chrome windows fontawesome-i2svg-active fontawesome-i2svg-complete">
  ...
  <head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{asset('../myCms/assets/img/favicons/favicon-32x32.png')}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('../myCms/assets/img/favicons/favicon-16x16.png')}}">
