            ...
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
              ...
              <li class="nav-item">
                ...
                <ul class="nav collapse false" id="settings">
                  <li class="nav-item">
                    <a class="nav-link" :href="route('admin.module.index')" aria-expanded="false">
                      <div class="d-flex align-items-center">
      ...
      <div class="content">
        <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
          ...
          <a class="navbar-brand me-1 me-sm-3" href="../index.html">
            <div class="d-flex align-items-center">
              <img class="me-2" src="/myCms/assets/img/icons/spot-illustrations/falcon.png" alt="" width="40" /><span
                ...
                <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
                  <div class="scrollbar list py-3" style="max-height: 24rem">
                      ...
                      <div class="d-flex align-items-center">
                        <div class="file-thumbnail me-2">
                          <img class="border h-100 w-100 fit-cover rounded-3"
                            src="/myCms/assets/img/products/3-thumb.png" alt="" />
                        </div>
                        <div class="flex-1">
                          <h6 class="mb-0 title">iPhone</h6>
                          <p class="fs--2 mb-0 d-flex">
                            <span class="fw-semi-bold">Antony</span><span class="fw-medium text-600 ms-2">27 Sep at
                              10:30 AM</span>
                          </p>
                        </div>
                      </div>
                    ...
                    <a class="dropdown-item px-card py-2" href="#!">
                      <div class="d-flex align-items-center">
                        <div class="file-thumbnail me-2">
                          <img class="img-fluid" src="/myCms/assets/img/icons/zip.png" alt="" />
                        </div>
                        <div class="flex-1">
                          <h6 class="mb-0 title">Falcon v1.8.2</h6>
                          <p class="fs--2 mb-0 d-flex">
                            <span class="fw-semi-bold">John</span><span class="fw-medium text-600 ms-2">30 Sep at 12:30
                              PM</span>
                          </p>
                        </div>
                      </div>
    ...
    <div class="offcanvas-body scrollbar-overlay px-card" id="themeController">
        ...
        <div class="row gx-2">
          <div class="col-6">
            ...
            <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherLight">
              <span class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                  src="/myCms/assets/img/generic/falcon-mode-default.jpg" alt="" /></span><span
          ...
          <div class="col-6">
            ...
            <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark">
              <span class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                  src="/myCms/assets/img/generic/falcon-mode-dark.jpg" alt="" /></span><span class="label-text">
                Dark</span></label>
          </div>
        </div>
      </div>
      ...
      <div class="d-flex justify-content-between">
        <div class="d-flex align-items-start">
          <img class="me-2" src="/myCms/assets/img/icons/left-arrow-from-left.svg" width="20" alt="" />
          <div class="flex-1">
      ...
      <div class="d-flex justify-content-between">
        <div class="d-flex align-items-start">
          <img class="me-2" src="/myCms/assets/img/icons/arrows-h.svg" width="20" alt="" />
          <div class="flex-1">
      ...
      <hr />
      <div class="d-flex align-items-start">
        <img class="me-2" src="/myCms/assets/img/icons/paragraph.svg" width="20" alt="" />
        <div class="flex-1">
        ...
        <div class="row gx-2">
          <div class="col-6">
            ...
            <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-transparent">
              <img class="img-fluid img-prototype" src="/myCms/assets/img/generic/default.png" alt="" /><span
          ...
          <div class="col-6">
            ...
            <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-inverted">
              <img class="img-fluid img-prototype" src="/myCms/assets/img/generic/inverted.png" alt="" /><span
          ...
          <div class="col-6">
            ...
            <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-card">
              <img class="img-fluid img-prototype" src="/myCms/assets/img/generic/card.png" alt="" /><span
          ...
          <div class="col-6">
            ...
            <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-vibrant">
              <img class="img-fluid img-prototype" src="/myCms/assets/img/generic/vibrant.png" alt="" /><span
                class="label-text"> Vibrant</span></label>
          </div>
        </div>
      </div>
      <div class="text-center mt-5">
        <img class="mb-4" src="/myCms/assets/img/icons/spot-illustrations/47.png" alt="" width="120" />
