          ...
          <div class="navbar-vertical-content scrollbar">
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
              ...
              <li class="nav-item">
                ...
                <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-file-alt"></span></span><span
              ...
              <li class="nav-item">
                ...
                <!-- parent pages--><a class="nav-link" href="../documentation/design-file.html" role="button"
                                       aria-expanded="false">
                <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-palette"></span></span><span
            ...
            <div class="settings mb-3">
              <div class="card alert p-0 shadow-none" role="alert">
                ...
                <div class="card-body text-center"><img
                  src="myCms/assets/img/icons/spot-illustrations/navbar-vertical.png" alt="" width="80"/>
              ...
              <div class="search-box" data-list='{"valueNames":["title"]}'>
                ...
                <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
                  <div class="scrollbar list py-3" style="max-height: 24rem;">
                    <h6 class="dropdown-header fw-medium text-uppercase px-card fs--2 pt-0 pb-2">Recently Browsed</h6><a
                    class="dropdown-item fs--1 px-card py-1 hover-primary" href="../app/events/event-detail.html">
                    <div class="d-flex align-items-center">
                    ...
                    <h6 class="dropdown-header fw-medium text-uppercase px-card fs--2 pt-0 pb-2">Suggested Filter</h6><a
                    class="dropdown-item px-card py-1 fs-0" href="../app/e-commerce/customers.html">
                    <div class="d-flex align-items-center"><span
                    ...
                    <a class="dropdown-item px-card py-2" href="#!">
                      <div class="d-flex align-items-center">
                        <div class="file-thumbnail me-2"><img class="img-fluid" src="myCms/assets/img/icons/zip.png"
                                                              alt=""/></div>
                        <div class="flex-1">
                    ...
                    <div class="d-flex align-items-center">
                      <div class="avatar avatar-l status-online me-2">
                        <img class="rounded-circle" src="myCms/assets/img/team/1.jpg" alt=""/>
                    ...
                    <a class="dropdown-item px-card py-2" href="../pages/user/profile.html">
                      <div class="d-flex align-items-center">
                        <div class="avatar avatar-l me-2">
                          <img class="rounded-circle" src="myCms/assets/img/team/2.jpg" alt=""/>
                    ...
                    <a class="dropdown-item px-card py-2" href="../pages/user/profile.html">
                      <div class="d-flex align-items-center">
                        <div class="avatar avatar-l me-2">
                          <img class="rounded-circle" src="myCms/assets/img/team/3.jpg" alt=""/>
                    ...
                    <div class="list-group list-group-flush fw-normal fs--1">
                        ...
                        <a class="notification notification-flush notification-unread" href="#!">
                          <div class="notification-avatar">
                            <div class="avatar avatar-2xl me-3">
                              <img class="rounded-circle" src="myCms/assets/img/team/1-thumb.png" alt=""/>
                      ...
                      <div class="list-group-item">
                        <a class="notification notification-flush" href="#!">
                          <div class="notification-avatar">
                            <div class="avatar avatar-2xl me-3">
                              <img class="rounded-circle" src="myCms/assets/img/icons/weather-sm.jpg" alt=""/>
                        ...
                        <a class="border-bottom-0 notification-unread  notification notification-flush" href="#!">
                          <div class="notification-avatar">
                            <div class="avatar avatar-xl me-3">
                              <img class="rounded-circle" src="myCms/assets/img/logos/oxford.png" alt=""/>
                      ...
                      <div class="list-group-item">
                        <a class="border-bottom-0 notification notification-flush" href="#!">
                          <div class="notification-avatar">
                            <div class="avatar avatar-xl me-3">
                              <img class="rounded-circle" src="myCms/assets/img/team/10.jpg" alt=""/>
  ...
  <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1"
    ...
    <div class="offcanvas-body scrollbar-overlay px-card" id="themeController">
        ...
        <div class="row gx-2">
          <div class="col-6">
            ...
            <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherLight"> <span
              class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                                              src="myCms/assets/img/generic/falcon-mode-default.jpg"
                                                              alt=""/></span><span
          ...
          <div class="col-6">
            ...
            <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark"> <span
              class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                                              src="myCms/assets/img/generic/falcon-mode-dark.jpg"
                                                              alt=""/></span><span
      ...
      <div class="d-flex justify-content-between">
        <div class="d-flex align-items-start"><img class="me-2" src="myCms/assets/img/icons/left-arrow-from-left.svg"
                                                   width="20" alt=""/>
          <div class="flex-1">
      ...
      <hr/>
      <div class="d-flex justify-content-between">
        <div class="d-flex align-items-start"><img class="me-2" src="myCms/assets/img/icons/arrows-h.svg" width="20"
                                                   alt=""/>
          <div class="flex-1">
      ...
      <hr/>
      <div class="d-flex align-items-start"><img class="me-2" src="myCms/assets/img/icons/paragraph.svg" width="20"
                                                 alt=""/>
        <div class="flex-1">
        ...
        <div class="row gx-2">
          <div class="col-6">
            ...
            <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-transparent"> <img
              class="img-fluid img-prototype" src="myCms/assets/img/generic/default.png" alt=""/><span
          ...
          <div class="col-6">
            ...
            <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-inverted"> <img
              class="img-fluid img-prototype" src="myCms/assets/img/generic/inverted.png" alt=""/><span
          ...
          <div class="col-6">
            ...
            <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-card"> <img
              class="img-fluid img-prototype" src="myCms/assets/img/generic/card.png" alt=""/><span class="label-text"> Card</span></label>
          </div>
          <div class="col-6">
            ...
            <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-vibrant"> <img
              class="img-fluid img-prototype" src="myCms/assets/img/generic/vibrant.png" alt=""/><span
              class="label-text"> Vibrant</span></label>
          </div>
        </div>
      </div>
      <div class="text-center mt-5"><img class="mb-4" src="myCms/assets/img/icons/spot-illustrations/47.png" alt=""
                                         width="120"/>
